...
let zagarantiranaSuma1=document.querySelector(".zagarantiranaSuma");
...
let vrijeme=document.querySelector(".vrijeme1");
...
'Ko pjeva pjesmu "Sinoc nisi bila tu" ?','Koji crtani lik ima cuvenu repliku "Sefe koji ti je vrag" ?',
'Koja drzava je prodala Aljasku Sjedinjenim Americkim Drzavama 30 marta 1867 ?','Koje boje je dragi kamen ametist ?',
'Koji glumac nije rodjen u Sjedinjenim Americkim Drzavama ?','Koji je latinski naziv za prst ?','Koje godine je osnovana kompanija "Google" ?',
'Osoba koja pati od ablutofobije, ima strah od ?','Kojoj drzavi administrativno pripada Bozicno drvce ?',
...
"Rusija","Narancaste","Tom Kruz","Humerus","1997",
...
"Ukrajina","Bijele","Stiven Sigal","Digitus","1999",
"Plakanja","Novi Zeland","Carls Latvidz Dodzson","Tuja","255 p.n.e-205 p.n.e"

];

let dodatiOdgovori4=[
"Beograd","Pjetao","Jupiter","Tina Tarner","Pera Detlic",
...
"Ako radite trbusnjake gradite misice na kom dijelu tijela ?",
"Koje boje je kaput Djeda Mraza ?",
"Kako glasi mnozina od rijeci cevap ?",
...
"Banda","Ledja","Bijele","Ceve","Sorc",
"26","Elephantidie","Nijamej","254. п. н. е. — 231. п. н. е.","Elektronski",
"1988","1665","Dzordz R.R Martin","Olivija Dzejn Kokbern","bijeli orao i bijela pcela"
...
"Dzordz R.R Martin","Kerin Ilejn Dzonson","Bijeli orao i bijela pcela"
...
'Ko upravlja avionom ?',
'Na sta mislimo ako kazemo "najbrzi cirkus na svijetu" ?',
'Ko je napisao roman "Robinzon Kruso" ?',
'Encefalitis je upala kog organa ?',
'Ko je napisao pjesmu "Pevam danju pevam nocu" u izvodjenju Zdravka Colica ?',
'Koliko godina je vladala kraljica Engleske i Irske-Elizabeta I Tjudor ?',
'gdje je nastao rukomet ?',
...
'Koja drzava je dvanesta na svijetu po broju stanovnika ?',
...
"Majkl Dzekson","Snijeg","Vozovodja","Formula 1","Carls Dikens",
...
'Iz koje drzave dolazi nogometas Cristiano Ronaldo ?',
'Koje godine je osnovana drustvena mreza Fejsbuk ?',
'Koliko vrijemena je postojao Sovjetski savez(SSSR) ?',
...
'Na kom takmicenju je pobjedila Marija Serifovic ?',
'gdje zivi jelen ?',
'Koji nadimak imaju navijaci Mancester UTD ?',
...
'Kom dijelu Afrike pripada Zimbabve ?',
...
"Akuminkum","Tezej","10","Stanoje i Miloje","Dena Kastijelaneta",
...
'Kako se zove rodno mjesto Vuka Karadzica ?',
...
'Koje godine je Brazil prvi put osvojio svijetsko prvenstvo u fudbalu ?',
...
'gdje se nalazi Kalemegdan ?',
'U koju vrstu literature spada "Krojcerova sonata" ?',
'Koja kompanija je druga na svijetu u prodaji sportske opreme ?',
...
'pjevacica Andjelina Djermanota nam je poznatija pod kojim imenom ?',
...
'Koja ptica je pjevacica ?',
'Mornar Popaj jaca misice jeduci ?',
'Kada pada kisa u ruci nosimo ?',
'Kako se zove vrh planine Kopaonik ?',
'Koje godine je Sekspir napisao djelo "Hamlet" ?',
'U kom klubu je karijeru zavrsio brazilski nogometas Rivaldo ?',
'Ko je napisao tekst za pjesmu Zdravka Colica "Okano" ?',
'Sa koliko godina u Indoneziji se postaje punoletan ?',
'Koliko tocno godina je trajao stogodisnji rat izmedju Engleske i Francuske ?',
...
'bijela','Golub','Spanac','Pecat','Pancicev vrh',
...
'Glagoli su rijeci koji oznacavaju mjesto,stanje i ?',
'Kako se zove najveci neprijatelj Nindza kornjaca ?',
'U kinder jaju mozete pronaci ?',
...
'Kojoj biljci nije potrebna sunceva svijetlost ?',
'Kada je zadnji put vidjena Halejeva kometa ?',
'Koliko minuta traje film "Avatar" ?',
'Ciji ucenik je bio starogrcki filozof Platon ?',
'gdje ce se odrzati Ljetne Olimpijske igre 2024 godine ?',
'Ko je napisao cuvenu knjigu za dijecu "Druzina sinjeg galeba" ?',
...
'Za koga francuski matematicar Zozef Luj Lagranz da je najveci genije svih vrijemena ?',
...
'Koliko je dugacka natrovnija zaba na svijetu ?'
...
'Kako glasi komparativ od rijeci "brz" ?',
...
'Kog novembra 1967 godine je rodjen bivsi tenisac Boris Beker ?',
...
'Kojim rezultatom je Hajduk iz Splita pobjedio Manchester utd 1980 godine ?'
...
'"Pinokio" je djelo napisano perom kog pisca ?',
...
'Betovenova "Mjeseceva sonata" je klavirska sonata po rednim brojem ?',
'Koja gljiva je otrovna ?',
'U kakvu vrstu prirodnog elementa spada Snijeg ?',
...
'Seranovi','Oblak','Vrijeci za spavanje','Isti tehnicari','Kukom',
'Kocka je bacena','12','Bijela slabunjavka','Mineral','Selena Gomez',
...
'Na kojoj strani svijeta zalazi Sunce ?',
...
'Sa kojom pesmom je Jugoslavija pobjedila na Evroviziji 1989 godine ?',
...
'Koliko vrijemena je Fransoa Miteran bio predsednik Francuske ?',
...
'Compose','Na kraju svijeta','Amharski','Mustafa','XHTML',
...
'Overtop','covijekoljublje','Srpske narodne pripovetke','Milos Tomic','Polifem'
...
'Overlord','covijekoljublje','Srpske narodne pripovetke','Ivan Bauer','Polifem'
...
zagarantiranaSuma1.textContent="";
ponovo=setInterval(podjelapostotaka, 100);
...
if(this.children[i].textContent===tocniOdgovori[tocnoRijesenje] && h6.textContent==="1")  {
...
if(this.children[i].textContent===tocniOdgovori2[tocnoRijesenje] && h6.textContent==="2")  {
...
if(this.children[i].textContent===tocniOdgovori3[tocnoRijesenje] && h6.textContent==="3")  {
...
if(this.children[i].textContent===tocniOdgovori4[tocnoRijesenje] && h6.textContent==="4")  {
...
if(this.children[i].textContent===tocniOdgovori5[tocnoRijesenje] && h6.textContent==="5")  {
...
if(this.children[i].textContent===tocniOdgovori11[tocnoRijesenje] && h6.textContent==="11")  {
...
if(this.children[i].textContent===tocniOdgovori12[tocnoRijesenje] && h6.textContent==="12")  {
...
if(this.children[i].textContent===tocniOdgovori13[tocnoRijesenje] && h6.textContent==="13")  {
...
if(this.children[i].textContent===tocniOdgovori14[tocnoRijesenje] && h6.textContent==="14")  {
...
if(this.children[i].textContent===tocniOdgovori15[tocnoRijesenje] && h6.textContent==="15")  {
...
if($(".odgovorJeTocan").length <= 4)  {

zagarantiranaSuma1.textContent="Osvojena suma: 0 kuna";  
osvojeno.value="";
...
zagarantiranaSuma1.textContent="Osvojena suma: 5.000 kuna";  
osvojeno.value="";

     }

if($(".odgovorJeTocan").length > 9)  {

zagarantiranaSuma1.textContent="Osvojena suma: 150.000 kuna";  
osvojeno.value="";
...
osvojeno.value=iznos[drugi].textContent+" kuna";
--drugi;

iznos[five5].classList.add("odgovorJeTocan");
--five5;
...
if(osvojeno.value==="5.000 kuna")  {

zagarantiranaSuma1.textContent="Zagarantirana suma: 5.000 kuna";
iznos[10].style.background="#993333";

}

if(osvojeno.value==="150.000 kuna")  {

zagarantiranaSuma1.textContent="Zagarantirana suma: 150.000 kuna";
iznos[5].style.background="#993333";

}

if(osvojeno.value==="5.000.000 kuna")  {

iznos[0].style.background="#993333";
zagarantiranaSuma1.textContent="CESTITKE OSVOJILI STE 5.000.000 kuna";
osvojeno.value="";
setTimeout(igramoIspocetka, 4000);
...
function netocanOdgovor() {
	
for(let i=0; i < odgovor.length; ++i)  {

if(odgovor[i].textContent===tocniOdgovori[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori2[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori3[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori4[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori5[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori11[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori12[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori13[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori14[tocnoRijesenje])  {
...
if(odgovor[i].textContent===tocniOdgovori15[tocnoRijesenje])  {
...
odustati2.removeEventListener("click", izbaciPotvrdu);
zagarantiranaSuma1.textContent="Osvojena suma: "+iznos[drugi +=1].textContent+" kuna";
osvojeno.value="";
...
if(odgovor[0].textContent===tocniOdgovori[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori2[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori2[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori2[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori2[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori3[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori3[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori3[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori3[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori4[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori4[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori4[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori4[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori5[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori5[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori5[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori5[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori11[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori11[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori11[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori11[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori12[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori12[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori12[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori12[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori13[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori13[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori13[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori13[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori14[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori14[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori14[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori14[tocnoRijesenje])  {
...
if(odgovor[0].textContent===tocniOdgovori15[tocnoRijesenje])  {
...
if(odgovor[1].textContent===tocniOdgovori15[tocnoRijesenje])  {
...
if(odgovor[2].textContent===tocniOdgovori15[tocnoRijesenje])  {
...
if(odgovor[3].textContent===tocniOdgovori15[tocnoRijesenje])  {
...
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori2[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori3[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori4[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori5[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori11[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori12[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori13[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori14[tocnoRijesenje];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori15[tocnoRijesenje];
...
let tri=parseInt(vrijeme.textContent);

vrijeme.textContent=tri-1;

if (vrijeme.textContent < 10) {

$(vrijeme).prepend(0);

   }

if(vrijeme.textContent < 1)  {
...
let postotak1=["85%","70%","55%"];
let postotak2=["5%","5%","5%","5%"];
let postotak3=["10%","10%","10%","10%"];
let postotak4=["15%","15%","15%","15%"];
...
publika[i].textContent=postotak1[0];

        }
if($(".odgovorJeTocan").length > 4)  {

publika[i].textContent=postotak1[1]; 

         }
if($(".odgovorJeTocan").length > 9)  {

publika[i].textContent=postotak1[2]; 
...
function podjelapostotaka() {
	
for(let l=0; l < odgovori.length; ++l)  {

if($(".odgovorJeTocan").length <= 4)  {

publika[l].textContent=postotak2[l];

        }
if($(".odgovorJeTocan").length > 4)  {

publika[l].textContent=postotak3[l];

         }
if($(".odgovorJeTocan").length > 9)  {

publika[l].textContent=postotak4[l];
...
$(".iznos").removeClass("odgovorJeTocan");
$(".odgovor").css("background","#6495ED");
$(".kviz").css("background","#6495ED");
...
if(this.children[i].textContent===tocniOdgovori6[tocnoRijesenje2] && h6.textContent==="6")  {
...
if(this.children[i].textContent===tocniOdgovori7[tocnoRijesenje2] && h6.textContent==="7")  {
...
if(this.children[i].textContent===tocniOdgovori8[tocnoRijesenje2] && h6.textContent==="8")  {
...
if(this.children[i].textContent===tocniOdgovori9[tocnoRijesenje2] && h6.textContent==="9")  {
...
if(this.children[i].textContent===tocniOdgovori10[tocnoRijesenje2] && h6.textContent==="10")  {
...
if(this.children[i].textContent===tocniOdgovori16[tocnoRijesenje2] && h6.textContent==="16")  {
...
if(this.children[i].textContent===tocniOdgovori17[tocnoRijesenje2] && h6.textContent==="17")  {
...
if(this.children[i].textContent===tocniOdgovori18[tocnoRijesenje2] && h6.textContent==="18")  {
...
if(this.children[i].textContent===tocniOdgovori19[tocnoRijesenje2] && h6.textContent==="19")  {
...
if(this.children[i].textContent===tocniOdgovori20[tocnoRijesenje2] && h6.textContent==="20")  {
...
restartirajOdgovore2();

}

function restartirajOdgovore2() {
...
iznos[trijeci].style.background="purple";
--trijeci;

osvojeno.value=iznos[cetvrti].textContent+" kuna";
--cetvrti;

iznos[five50].classList.add("odgovorJeTocan");
--five50;
...
function netocanOdgovor2() {
	
for(let i=0; i < odgovor.length; ++i)  {

if(odgovor[i].textContent===tocniOdgovori6[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori7[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori8[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori9[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori10[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori16[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori17[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori18[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori19[tocnoRijesenje2])  {
...
if(odgovor[i].textContent===tocniOdgovori20[tocnoRijesenje2])  {
...
$(".potvrdaOdustajanja").css("visibility","hidden");
odustati2.removeEventListener("click", izbaciPotvrdu);
zagarantiranaSuma1.textContent="Osvojena suma: "+iznos[cetvrti +=1].textContent+" kuna";
osvojeno.value="";
...
if(odgovor[0].textContent===tocniOdgovori6[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori6[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori6[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori6[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori7[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori7[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori7[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori7[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori8[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori8[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori8[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori8[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori9[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori9[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori9[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori9[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori10[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori10[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori10[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori10[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori16[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori16[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori16[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori16[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori17[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori17[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori17[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori17[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori18[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori18[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori18[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori18[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori19[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori19[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori19[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori19[tocnoRijesenje2])  {
...
if(odgovor[0].textContent===tocniOdgovori20[tocnoRijesenje2])  {
...
if(odgovor[1].textContent===tocniOdgovori20[tocnoRijesenje2])  {
...
if(odgovor[2].textContent===tocniOdgovori20[tocnoRijesenje2])  {
...
if(odgovor[3].textContent===tocniOdgovori20[tocnoRijesenje2])  {
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori6[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori7[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori8[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori9[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori10[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori16[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori17[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori18[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori19[tocnoRijesenje2];
...
takmicar.textContent="Ja: "+ pitanja.textContent;
pomaganje.textContent="Prijatelj: "+" "+"Odgovor je: "+tocniOdgovori20[tocnoRijesenje2];
